...
const SettingsPage: React.FC = () => {
  ...
  const checkConnection = () => {
    ...
    api.checkHealth()
      .then((data) => {
        setHealth(data);
        showToast('info', 'Connectivity check complete');
      })
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="border-b-4 border-white pb-6 mb-10">
          <h1 className="text-5xl text-white mb-2 leading-none">CONFIG</h1>
          <p className="text-gray-400 font-mono uppercase tracking-widest">API CONNECTIONS & SECRETS</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-black border-2 border-white p-0 relative">
            <div className="bg-white text-black p-3 font-mono font-bold uppercase flex justify-between items-center border-b-2 border-white">
                <span className="flex items-center gap-2"><Server size={18}/> API GATES</span>
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="relative">
                    <div className="flex justify-between items-center mb-2">
                        ...
                        {health?.heedsConnection ? (
                            <span className="bg-[#00FF00] text-black text-xs font-mono px-1 font-bold">ONLINE</span>
                        ) : (
                            <span className="bg-red-500 text-white text-xs font-mono px-1 font-bold">OFFLINE</span>
                        )}
                    </div>
                ...
                <div className="pt-4 border-t border-gray-800">
                    <Button onClick={checkConnection} disabled={checking} className="w-full" variant="outline">
                        {checking ? 'PINGING...' : 'TEST CONNECTIVITY'}
                    </Button>
                </div>
            </div>
        </div>
        ...
        <div className="bg-black border-2 border-white p-0 relative opacity-75">
            <div className="bg-gray-800 text-white p-3 font-mono font-bold uppercase flex justify-between items-center border-b-2 border-white">
                <span className="flex items-center gap-2"><ShieldCheck size={18}/> SECRETS</span>
                <Power size={18} />
            </div>
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="p-4 bg-[#FFFF00]/10 border border-[#FFFF00] text-[#FFFF00] text-xs font-mono">
                    <p>WARNING: Secrets are managed via environment variables. Please consult the documentation to rotate keys.</p>
                </div>
            </div>
        </div>
