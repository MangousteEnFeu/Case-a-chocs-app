...
import { Calendar, MapPin, Users, RefreshCw, Check, Ticket, Music, Edit3 } from 'lucide-react';
...
interface EventCardProps {
    ...
    onEdit?: (event: HeedsEvent) => void;  // NOUVEAU
    isSyncing: boolean;
}

const EventCard: React.FC<EventCardProps> = ({ event, onSync, onEdit, isSyncing }) => {
            ...
            <div className="h-40 bg-gray-900 relative border-b-2 border-white overflow-hidden">
                ...
                {onEdit && (
                    <button
                        ...
                        className="absolute top-2 right-2 z-10 p-2 bg-black/70 border border-white text-white hover:bg-[#E91E63] hover:border-[#E91E63] transition-all opacity-0 group-hover:opacity-100"
                        title="Modifier"
                    >
                        <Edit3 size={14} />
                    </button>
