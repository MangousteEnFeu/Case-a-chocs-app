...
-- Nettoyage préventif (pour être sûr de la structure lors des reloads)
...
-- 2. Table des événements (Modifiée : sans artist_id)
CREATE TABLE IF NOT EXISTS events (
                                      id VARCHAR(255) PRIMARY KEY,
                                      title VARCHAR(255) NOT NULL,      -- Titre de la soirée (ex: "Techno Night")
                                      subtitle VARCHAR(255),            -- Sous-titre (ex: "Closing Season")
                                      ...
                                      description TEXT,
                                      genre VARCHAR(100)
    -- Note: artist_id a été supprimé ici
);

-- 3. NOUVELLE TABLE : Liaison Événements <-> Artistes
CREATE TABLE IF NOT EXISTS event_artists (
                                             event_id VARCHAR(255) NOT NULL,
                                             artist_id VARCHAR(255) NOT NULL,
                                             display_order INTEGER DEFAULT 0, -- Pour gérer l'ordre (tête d'affiche en premier)
...
-- 5. Table des logs de synchronisation
